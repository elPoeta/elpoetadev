    ...
    <footer className="text-gray-400 bg-gray-900 body-font">
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-400 text-sm text-center sm:text-left">© {new Date().getFullYear()} elPoetaDev —
            <a href="https://github.com/elPoeta" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@elPoeta</a>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <a href="https://t.me/elPoetaDeveloper" rel="noopener noreferrer" target="_blank" className="ml-3 text-gray-400">
            ...
            <a href="https://twitter.com/elPoetaDev" rel="noopener noreferrer" target="_blank" className="ml-3 text-gray-400">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                <title>Twitter</title>
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
              </svg>
            </a>
            <a href="https://discordapp.com/users/1013999474357571594" rel="noopener noreferrer" target="_blank" className="ml-3 text-gray-400">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>Discord</title>
            ...
            <a href="https://www.linkedin.com/in/leonardo-tosetto" rel="noopener noreferrer" target="_blank" className="ml-3 text-gray-400">
